      ...
      <section className="bg-[#eaeff5] rounded-2xl lg:col-span-3 md:col-span-1 lg:row-span-3 p-5">
        <div className="rounded-2xl bg-white h-full flex flex-col justify-center items-center px-16 py-5">
          ...
          <div className="text-gray-700 leading-relaxed">
            <p>Hey, I’m Gaurav — I build things for the web that look good and feel right.</p>
            <p>I’m studying Electronics & Communication, but code’s where I really come alive. React, Vite, Tailwind, and Firebase are the tools I use to bring ideas to life.</p>
            <p>I builds interfaces that speak quietly — clean, clever, and human.</p>
